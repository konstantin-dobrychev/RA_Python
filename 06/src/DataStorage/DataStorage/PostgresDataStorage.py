...
class PostgresDataStorage(DataStorage):
    ...
    async def create(self, options: dict):
        ...
        await self._connection.execute(
            'CREATE TABLE IF NOT EXISTS objects (key TEXT, name TEXT, age INT, city TEXT, job TEXT)'
        )
    ...
    async def put_object(self, key: str, value: dict):
        ...
        async with self._connection.transaction():
            await self._connection.execute('INSERT INTO objects VALUES ($1, $2, $3, $4, $5)', key, name, age, city, job)
